...
function CartView({ greeting }) {
  ...
  Toast.fire({
    ...
    if (cart.length === 0) {
      ...
      <div className="row py-lg-5">
          ...
          <img src={bugMinerLogo} width="480px" alt="" className="img-fluid" />
          <p></p>
  ...
  return (
   ...
   <div className="row py-lg-2">
    <div><Badge bg="primary" className="m-1"><h6>Total de items: {itemsTotal()}</h6></Badge><Badge className="m-3" bg="primary"><h6> Costo Total: $ {precioTotal()} USD</h6></Badge><div></div><div><Link to="/">regresar al catálogo</Link></div> 
     </div>
   </div>
